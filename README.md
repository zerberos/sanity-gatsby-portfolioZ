...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/2rd8a5pg/settings/api) and create a token with read rights.
